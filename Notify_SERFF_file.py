...
for index,rows in today_file.iterrows():
    if rows[0] not in list_files:
        ...
        msg1 = 'Tracking Number : {}'.format(rows[1])

        msg2 = 'From : {}'.format(rows[2])

        msg3 = 'On : {}'.format(rows[3])
...
SENDERNAME = 'Rohit Sarkar'

# Replace recipient@example.com with a "To" address. If your account
# is still in the sandbox, this address must be verified.
RECIPIENT  = 'recipient mail address'
...
message = """ \
              ...
              {} \n
              {} \n
        """.format(msg, msg1, msg2, msg3)

# The HTML body of the email.

message1 = """ \
              There is no change in the file as compared to yesterday's file.
